...
export const OSOGBO_AREAS = [
  ...
  "Okinni", "Old Garage", "Owode", "Powerline", "Ring Road", "Sabo",
...
export const ARTISAN_SKILLS = [
  ...
  "Solar Installer", "Tailor", "Tiler", "Trader", "Tutor",
  "Upholstery Repairer", "Videographer", "Welder", "Farmer",
  "Fisherman", "Poultry Farmer", "Herbalist/Traditional Healer",
  "Auto Spare Parts Dealer", "Furniture Maker", "Bag/Shoe Maker",
  "Aluminium/Glass Fabricator", "Roofing Contractor", "Painter (Signwriter)",
  "Barbing Salon Owner", "Provision Store Owner", "Cyber Cafe Operator",
  "Bicycle/Motorcycle Repairer", "Key Cutter/Locksmith", "Wig Vendor",
  "Recharge Card/Airtime Vendor", "Water Vendor", "Other Skill",
].sort();